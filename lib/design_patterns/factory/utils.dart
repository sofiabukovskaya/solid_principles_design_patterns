...
import 'package:solid_principles_design_patterns/design_patterns/factory/shape.dart';
import 'package:solid_principles_design_patterns/design_patterns/factory/shape_factory.dart';
      ...
      case ShapesEnum.circle:
        {
          double radius =
              rnd.nextDouble() * (radiusMinMax.height - radiusMinMax.width) +
                  radiusMinMax.width;
          Point v1 = Point(
            rnd.nextDouble() * (constraints.width - margins.width - radius / 2),
            rnd.nextDouble() * (constraints.height - margins.height),
          );
